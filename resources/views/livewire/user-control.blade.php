            ...
            <form wire:submit.prevent="save" class='p-6 bg-[#45025b] rounded-b-md max-h-[70vh] overflow-y-auto'>
                <div class="mb-4">
                    ...
                    <input type="text" wire:model="nmuser"
                        ...
                        >
                    @error('nmuser') <span class="text-campus-warn text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" wire:model="password"
                        class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300">
                    @error('password') <span class="text-campus-warn text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" wire:model="password_confirmation"
                        class="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300">
                    @error('verifpassword') <span class="text-campus-warn text-sm">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    @error('kdotoritas') <span class="text-campus-warn text-sm">{{ $message }}</span> @enderror
                </div>
